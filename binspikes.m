...
%   - removes undocumented final bin behavior when data is an array of
...
%    if max(dtmp)>max(t); t=[t maxtime+dt]; end;  %commented to remove undocumented behavior; sserene 181022
   x=histc(dtmp,t);
