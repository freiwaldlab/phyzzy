function [ analysisParamFilename ] = buildAnalysisParamFileRISEmovie( )    
...
switch machine
  case 'rig'
    ...
    stimParamsFilename = '/Users/stephenserene/Desktop/Freiwald/AnalysisSerene/StimParamsRISE.mat';   %#ok
  case 'laptop'
  ...
  case 'hopper'
    ...
    stimParamsFilename = '/Freiwald/sserene/ephys/AnalysisSerene/StimParamsRISE.mat';   %#ok
  case 'turing'
    ephysVolume = '/Freiwald/sserene/ephys/ALAN_DATA/Blackrock'; 
...
excludeStimParams.fixPre = 2200; %ms
excludeStimParams.fixPost = 2200; %ms
excludeStimParams.flashPre = 2200;  %ms
excludeStimParams.flashPost = 2200; %ms
...
psthParams.psthPre = 2300; % if e.g. +200, then start psth 200ms before trial onset; 
psthParams.psthImDur = 0;  % only need to set this for variable length stim runs; else, comes from log file
psthParams.psthPost = 2300;
...
%
analysisGroups.colorPsthEvoked.groups = {{'HumanheadoriB11RISE00out';'HumanheadoriE11RISE00out';'MonkeyheadoriC7RISE00out';'monkeybodypart7RISE00out'}};
analysisGroups.colorPsthEvoked.names = {'RISEmovie'};
analysisGroups.colorPsthEvoked.colors = {{'b';'c';'y';'g'}};
%
analysisGroups.linePsthEvoked.groups = {{'HumanheadoriB11RISE00out';'HumanheadoriE11RISE00out';'MonkeyheadoriC7RISE00out';'monkeybodypart7RISE00out'};{'HumanheadoriB11RISE00out'};{'HumanheadoriE11RISE00out'};{'MonkeyheadoriC7RISE00out'};{'monkeybodypart7RISE00out'}};
analysisGroups.linePsthEvoked.names = {'RISEmovie';'HumanB11RISEmov';'HumanE11RISEmov';'MonkeyC7RISEmov';'monkeybody7RISEmov'};
analysisGroups.linePsthEvoked.colors = {{'b';'c';'y';'g'};{'b'};{'c'};{'y'};{'g'}};
%
...
%
analysisGroups.tfSpectraByCategory.groups = {{'HumanheadoriB11RISE00out'};{'HumanheadoriE11RISE00out'};{'MonkeyheadoriC7RISE00out'};{'monkeybodypart7RISE00out'}};%{'object'};{'body'}      %todo: add tf spectra diff?
analysisGroups.tfSpectraByCategory.names = {'HumanB11RISEmov';'HumanE11RISEmov';'MonkeyC7RISEmov';'monkeybody7RISEmov'};
%
analysisGroups.lfpSingleTrialsByCategory.groups = {{'HumanheadoriB11RISE00out'};{'HumanheadoriE11RISE00out'};{'MonkeyheadoriC7RISE00out'};{'monkeybodypart7RISE00out'}};
analysisGroups.lfpSingleTrialsByCategory.names = {'HumanB11RISEmov';'HumanE11RISEmov';'MonkeyC7RISEmov';'monkeybody7RISEmov'};
%
analysisGroups.analogInSingleTrialsByCategory.groups = {{'HumanheadoriB11RISE00out'};{'HumanheadoriE11RISE00out'};{'MonkeyheadoriC7RISE00out'};{'monkeybodypart7RISE00out'}};
analysisGroups.analogInSingleTrialsByCategory.names = {'HumanB11RISEmov';'HumanE11RISEmov';'MonkeyC7RISEmov';'monkeybody7RISEmov'};
...
%
analysisGroups.tfCouplingByCategory.groups = {{'HumanheadoriB11RISE00out'};{'HumanheadoriE11RISE00out'};{'MonkeyheadoriC7RISE00out'};{'monkeybodypart7RISE00out'}}; %#ok
%%%%%
