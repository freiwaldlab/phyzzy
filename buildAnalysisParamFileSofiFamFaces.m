function [ analysisParamsFilename ] = buildAnalysisParamFileSofiFamFaces( )    
...
switch machine
  case 'rig'
    ...
    stimulusLogVolume = '/';
    outputVolume = '';
    stimParamsFilename = '/Volumes/FreiwaldShares/slandi/ephys/tests_2017/AnalysisSofi/StimParamsFullexp01_v2.mat';   %#ok
  case 'laptop'
    ephysVolume = ''; 
    stimulusLogVolume = '';
    outputVolume = '';
...
excludeStimParams.excludeFixation = 1; % exclude due to bad fixation
...
analysisGroups.selectivityIndex.groups = {{'Face';'nonFace'},{'Familiar';'nonFamiliar'}};
%
analysisGroups.stimPrefBarPlot.groups = {{{'humanFam','humanNFam','monkeyFam','monkeyNFam','objectFam','objectNFam'}}};                        
analysisGroups.stimPrefBarPlot.colors  = {{{'b';'c';'b';'c';'b';'c'}}};
analysisGroups.stimPrefBarPlot.names = {'fobPlus'};
analysisGroups.stimPrefBarPlot.groupDepth = 2;

analysisGroups.stimulusLabelGroups.groups = {{'humanFam','humanNFam','monkeyFam','monkeyNFam','objectFam','objectNFam','GrayBG'}};
