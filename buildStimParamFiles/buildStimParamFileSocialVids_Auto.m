...
{'Cut_Order1Mounting3.avi', 'socialInteraction', 'chasing','highMotion'}; ...
...
categoryLabels = {'agents', 'objects', 'scramble', 'scene', 'interaction', 'nonInteraction', 'idle', 'socialInteraction',...
...
%% Duct tape section
lastbit = {...
  {'monkeyObserving_1193.avi', 'agents', 'interaction', 'socialInteraction', 'observing', 'background'}...
  };

paramArray = vertcat(paramArray, lastbit);
pictureLabels = vertcat(pictureLabels, {'monkeyObserving3a'});
